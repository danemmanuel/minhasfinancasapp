...
class GerenciarOperacao extends StatefulWidget {
  ...
  GerenciarOperacao(
      {required this.tipoOperacao, this.operacaoData, required this.onSave});

  @override
  _GerenciarOperacaoModalState createState() => _GerenciarOperacaoModalState();
}

class _GerenciarOperacaoModalState extends State<GerenciarOperacao> {
  ...
  Widget build(BuildContext context) {
    ...
    return Dialog(
      ...
      child: Container(
          width:
              MediaQuery.of(context).size.width * 1, // 95% da largura da tela
            ...
            child: Column(
              children: [
                ...
                DropdownButtonFormField<String>(
                  value:
                      operacaoData != null && operacaoData['categoria'] != null
